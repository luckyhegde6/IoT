...
pixels.setPixelColor(i+1, j,j, 255-j);
pixels.setPixelColor(i+2, j,j,j);
pixels.setPixelColor(i+3, 255-j,255-j, 255-j);
pixels.setPixelColor(i+4, 255-j,255-j, j);
pixels.setPixelColor(i+5, j,255-j, j);
pixels.setPixelColor(i+6, 255-j,j, 255-j);
j++;
 delay(100);
 pixels.show(); 
}
